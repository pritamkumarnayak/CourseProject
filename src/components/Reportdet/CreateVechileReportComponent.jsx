...
class CreateVechileReportComponent extends Component {
    constructor(props){
        super(props)
    ...
    saveOrUpdateReport = (e) => {
        ...
        if(this.state.id === '_add'){
            VechileService.createReport(report).then(res =>{
                this.props.history.push('/report');
            });
        }else{
            VechileService.updateReport(report, this.state.id).then( res => {
                this.props.history.push('/report');
            });
        }
    }
                ...
                <div className ="container">
                    <div className = "row">
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">Input Details</h3>
...
export default CreateVechileReportComponent;