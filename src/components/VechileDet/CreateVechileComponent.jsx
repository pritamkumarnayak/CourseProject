...
class CreateVechileComponent extends Component {
    constructor(props){
        super(props)
                ...
                <div className ="container">
                    <div className = "row">
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">Register New Vehicle</h3>
                            <div className = "card-body">
                                <form>
                                    ...
                                    <button className="btn btn-success" onClick={this.saveVechile}>Save</button>
...
export default CreateVechileComponent;
